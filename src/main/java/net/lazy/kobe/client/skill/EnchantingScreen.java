...
public class EnchantingScreen extends MasteryScreenBase<MasteryMenu> {

    public EnchantingScreen(MasteryMenu menu, Inventory inv, Component title) {
    ...
    private MasteryProgress data() {
        return minecraft.player
                ...
                .getOrCreate(MasteryType.ENCHANTING);
    }
    ...
    protected void onClaimAll() {
        NetworkHandler.sendToServer(
                new MasteryClaimAllPacket(MasteryType.ENCHANTING)
        );
    }

    @Override
    protected Component getTitleText() {
        return Component.literal("ENCHANTING MASTERY • Level " + getPlayerLevel());
    }
    ...
    protected List<Component> getPerkTooltip(int level) {
        ...
        List<Component> rewards =
                MasteryRewardTooltip.getTooltip(MasteryType.ENCHANTING, level);
